...
base_price_unit = st.sidebar.selectbox(
    "Select base currency for conversion", currency_list
)
symbols_price_unit = st.sidebar.selectbox(
    "Select target currency to convert to", currency_list
)
