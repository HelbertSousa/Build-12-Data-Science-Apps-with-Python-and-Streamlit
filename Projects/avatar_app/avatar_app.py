...
option_skin_color = st.sidebar.selectbox(
    "Skin color", list_skin_color, index=index_skin_color
)

st.sidebar.subheader("Head top")
option_top_type = st.sidebar.selectbox("Head top", list_top_type, index=index_top_type)
option_hair_color = st.sidebar.selectbox(
    "Hair color", list_hair_color, index=index_hair_color
)
option_hat_color = st.sidebar.selectbox(
    "Hat color", list_hat_color, index=index_hat_color
)

st.sidebar.subheader("Face")
option_facial_hair_type = st.sidebar.selectbox(
    "Facial hair type", list_facial_hair_type, index=index_facial_hair_type
)
option_facial_hair_color = st.sidebar.selectbox(
    "Facial hair color", list_facial_hair_color, index=index_facial_hair_color
)
option_mouth_type = st.sidebar.selectbox(
    "Mouth type", list_mouth_type, index=index_mouth_type
)
option_eye_type = st.sidebar.selectbox("Eye type", list_eye_type, index=index_eye_type)
option_eyebrow_type = st.sidebar.selectbox(
    "Eyebrow type", list_eyebrow_type, index=index_eyebrow_type
)

st.sidebar.subheader("Clothe and accessories")
option_accessories_type = st.sidebar.selectbox(
    "Accessories type", list_accessories_type, index=index_accessories_type
)
option_clothe_type = st.sidebar.selectbox(
    "Clothe type", list_clothe_type, index=index_clothe_type
)
option_clothe_color = st.sidebar.selectbox(
    "Clothe Color", list_clothe_color, index=index_clothe_color
)
option_clothe_graphic_type = st.sidebar.selectbox(
    "Clothe graphic type", list_clothe_graphic_type, index=index_clothe_graphic_type
)
